...
// Constructor initializes the reference to the HardwareSerial object
BricoGeek_DirectDriveServo::BricoGeek_DirectDriveServo(HardwareSerial& serial, uint8_t id)
